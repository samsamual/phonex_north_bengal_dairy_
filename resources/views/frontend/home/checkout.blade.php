                   ...
                   <div class="card">
                        <div class="card-body">
                            @php
                                ...
                                $shippingCost = $ws->shipping_charge ?? 150;
                            @endphp

                            <div class="d-flex justify-content-between fw-semibold text-primary py-0">
                                <span class="w3-text-deep-orange">Shipping Cost</span>
                                <span class="shipping-cost">Tk. {{ number_format($shippingCost, 2) }}</span>
                            </div>
                        </div>
                    </div>
