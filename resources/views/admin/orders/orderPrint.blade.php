...
<div class="container my-4">
  ...
  <div class="row invoice-header align-items-center">
    <div class="col-2">
      @if($ws->logo())
      <img width="70" height="79" src="{{ route('imagecache', ['template'=>'original','filename' => $ws->logo_alt()]) }}" alt="logo" class="img-fluid">
      @endif
    </div>
    <div class="col-7">
  ...
  <div class="row mb-4">
    <div class="col-md-8">
      ...
      <table class="table table-sm table-borderless">
        <tr>
          <th width="80">Name:</th>
          <td class="bg-light">{{ $order->name ?? $order->user->name  }}</td>
        </tr>
        <tr>
          <th>Email:</th>
          <td class="bg-light">{{  $order->email ?? $order->user->email }}</td>
        </tr>
        <tr>
          <th>Mobile:</th>
          <td class="bg-light">{{ $order->mobile ?? $order->user->mobile }}</td>
        </tr>
        <tr>
          <th>Adress:</th>
