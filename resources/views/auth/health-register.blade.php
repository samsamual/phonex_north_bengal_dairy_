                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        <h5 class="text-primary">Health Register Now</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                <h1>Health Card Form</h1>
            </div>
            <div class="col-md-4 order-1 order-md-2 align-self-center">
                <ul class="breadcrumb d-block text-md-end breadcrumb-light">
                    <li><a href="{{ url('/') }}">Home</a></li>
                    <li class="active">Health Card</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-lg rounded-3">
                    <div class="card-header bg-primary text-white text-center">
                        <h4 class="my-1 font-weight-bold w3-xlarge">Health Card Form</h4>
                        <hr class="my-2">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control" placeholder="Enter Name" value="{{ Auth::user()->name }}" required >
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="father_name" name="father_name" class="form-control" placeholder="Enter Father Name" value="{{ Auth::user()->father_name }}" required>
                                @error('father_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="present_address" name="present_address" class="form-control" placeholder="Enter Present Address" value="{{ Auth::user()->present_address }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="permanent_address" name="permanent_address" class="form-control" placeholder="Enter Permanent Address" value="{{ Auth::user()->permanent_address }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="reg_date" name="reg_date" class="form-control" value="{{ Auth::user()->reg_date }}" required>
                                @error('reg_date')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            {{--<div class="mb-3">
                                ...
                                <input type="text" id="health_history" name="health_history" class="form-control" placeholder="Enter health history" value="{{ Auth::user()->health_history }}" >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="nid" name="nid" class="form-control" placeholder="Enter Your Nid Number" value="{{ Auth::user()->nid }}" required>
                                @error('nid')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="mobile" name="mobile" class="form-control" placeholder="E.g. 01700 123456" value="{{ Auth::user()->mobile }}" required>
                                @error('mobile')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="dob" name="dob" class="form-control" value="{{ Auth::user()->dob }}" required>
                                @error('dob')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="ssc_passing" name="ssc_passing" class="form-control" placeholder="S.S.C Passing Year" value="{{ Auth::user()->ssc_passing }}" required>
                                @error('ssc_passing')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="ssc_registration" name="ssc_registration" class="form-control" placeholder="S.S.C Registration Year" value="{{ Auth::user()->ssc_registration }}" required>
